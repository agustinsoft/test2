...
import com.mycorp.controller.Zendesk;
...
public class ZendeskServiceImpl implements ZendeskService {
    ...
    /* (non-Javadoc)
	 * @see com.mycorp.services.ZendeskService#altaTicketZendesk(util.datos.UsuarioAlta, java.lang.String)
	 */
    @Override
	public String altaTicketZendesk(UsuarioAlta usuarioAlta, String userAgent){
		...
		String idCliente = cargarDatosFormulario(usuarioAlta, userAgent, mapper);
    ...
    private String cargarDatosFormulario (UsuarioAlta usuarioAlta,  String userAgent, ObjectMapper mapper){	
